...
export default function Admin() {
  ...
  const departmentColors = {
    "PWD": "bg-purple-50 text-purple-700 border border-purple-100",
    "Waste Management": "bg-purple-50 text-purple-700 border border-purple-100",
    "Electricity": "bg-purple-50 text-purple-700 border border-purple-100",
